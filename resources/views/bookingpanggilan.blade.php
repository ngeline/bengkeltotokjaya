...
@section('content')
                                ...
                                <div class="col">
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-lg-12 text-center">
                                            <h1 class="text-white display-1">SERVICE PANGGILAN </h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @enderror
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-1 mb-3">
                                            ...
                                            <!-- <a href="https://google.co.id/maps/" target="_blank" class="btn form-control" style="background: #4D73DD; color: white;"><i
                                                            class="fa fa-map"></i></a> -->
                                            <a onclick="getLocation()" target="_blank" class="btn form-control"
                                                style="background: #4D73DD; color: white;"><i class="fa fa-map"></i></a>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('service_complaint') is-invalid @enderror" name="complaint" rows="7"
                                    ...
                                    <input type="submit" id="submit" class="clearfix btn btn-primary"
                                        value="Kirim">
                                </form>
                            </div>
                        </div><br><br>
