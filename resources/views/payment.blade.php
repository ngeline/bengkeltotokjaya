...
<div class="container py-4">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mt-2">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 style="color: black;"><i style="color: black;" class="fa fa-pencil-alt"></i> Konfirmasi pembayaran</h4>
                    @if(!empty($service))
                    <h2 style="color: red; font-size: 12pt;" align="right">Total pembayaran anda adalah is Rp. {{ number_format($service->total_price)}}</h2>
                    @if(count($errors) > 0)
                    ...
                    <form method="POST" action="{{ url('payment') }}/{{ $service->id }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input placeholder="Masukkan nama.." style="background-color: #ecebeb; color: black;" id="namaRek" type="text" class="form-control @error('namaRek') is-invalid @enderror" name="namaRek">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input placeholder="Masukkan Bank.." style="background-color: #ecebeb; color: black;" id="email" type="text" class="form-control @error('bank') is-invalid @enderror" name="bank">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input value="{{($service->total_price)}}" readonly style="background-color: #ecebeb; color: black;" id="total" type="text"  class="form-control @error('total') is-invalid @enderror" name="total">
                        ...
                        <div class="form-group row">
                            <label for="buktiPayment" class="col-md-2 col-form-label text-md-right">Bukti Foto</label>
