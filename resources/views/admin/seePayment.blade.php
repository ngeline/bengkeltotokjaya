...
<div class="container py-4">
    <div class="row">
        <div class="col-md-12">
            <a href="{{ url('bookingdata') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
        <div class="col-md-12 mt-2">
            <div class="card">
                ...
                <form method="POST" action="{{ route('seePayment.update', $booking->id) }}">
                    ...
                    <h3 style="color: gray;"><i for="status" class="col-md-6 col-form-labelt" style="color: #8B0000;"></i>Status</h3>
                            <div class="col-md-7">
                                <select style="width: 100%;  padding: 12px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;  resize: vertical; color: gray;" id="status" name="status">
                        ...
                        <div class="card-body row mb-0 mt-0">
                            <div class="col-md-12 offset-md-0" align="right">
                                <button type="submit" class="btn" style=" width: 100px;font-weight: bold; font-size: 16px; background:  #4D73DD; color: white;">
                                    Simpan
                                </button>
                            </div>
                        </div>
