                ...
                <div class="card">
                    ...
                    <div class="card-body" >
                        <form action="{{ route('addscari') }}" method="GET">
                            <div class="row mb-3">
                                <div class="col-3">
                                    <input type="search" class="form-control float-right" placeholder="Cari" id="cari" name="cari">
                                </div>
                                <div class="col-4">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-search" aria-hidden="true"></i> Search</button>
                                    <a href="/addSparepart" class="btn btn-primary"><i class="fa fa-refresh"></i> </a>
                                </div>
                        </form>
                    </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <form method="post" action="{{ url('/sparepart/need') }}/{{ $sparepart->id }}">
                                            ...
                                            @csrf
                                            <button type="submit" class="btn" align="left" style="background: #8B0000; color: white;" @if($sparepart->stock == 0) disabled @endif><i class="fas fa-shopping-cart"></i> Tambah</button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
