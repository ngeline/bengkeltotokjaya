...
<div class="col-md-12">
    <div class="card mt-2">
        <div class="card-body" style="color: black;">
            @if(!empty($booking))
            <p style="color: #008080">Status Pemesanan {{ $booking->status }} / A.n {{ $booking->name_stnk }} </p>
            <p>No. Antrian : {{ $booking->no_antrian }} / Tanggal Pemesanan : {{ $booking->service_date }}</p><br>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <select style="width: 100%;  padding: 12px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;  resize: vertical; color: gray;" name="status" required>
                                        <option hidden value="Servis diproses">{{ $booking->status }}</option>
