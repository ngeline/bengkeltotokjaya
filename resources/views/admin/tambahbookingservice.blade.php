                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="jenis_mobil" id="jenis_mobil"
                                                ...
                                                <div class="col-md-6" rows="7">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="7" type="text"
                                                            class="form-control  @error('service_complaint') is-invalid @enderror"
                                                            name="complaint" id="complaint"
                                                            placeholder="Masukkan keluhan mobil" required></textarea>
                                                        @error('complaint')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
