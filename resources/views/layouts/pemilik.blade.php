                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('pemilik.home')}}" aria-expanded="false"><i
                                    class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('laporansparepart')}}" aria-expanded="false"><i
                                    class="mdi mdi-engine"></i><span class="hide-menu">Suku Cadang</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('perkembangan')}}" aria-expanded="false"><i
                                    class="mdi mdi-signal"></i><span class="hide-menu">Grafik Perkembangan</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('laporanservice')}}" aria-expanded="false"><i
                                    class="mdi mdi-car-connected"></i><span class="hide-menu">Servis</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('laporantransaksi')}}" aria-expanded="false"><i
                                    class="mdi mdi-book-multiple-variant"></i><span class="hide-menu">Laporan Transaksi</span></a></li>
                        <!-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
