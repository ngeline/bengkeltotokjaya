...
<div class="container py-4">
    ...
    <div class="row">
        ...
        <a href="{{ url('history') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali </a>
            @if(!empty($booking))
            <a href="{{ url('invoice/print') }}/{{ $booking->id }}" class="btn btn-primary"
                style="" target="_blank"><i class="fas fa-print"></i> Print PDF</a>
        </div>
                    ...
                    <div class="col-md-12">
                        <center>
                            <p style="color: #008080;"><b style="font-size: 20px;">Bengkel Mobil Totok Jaya </b><br>
                                Jalan Raya, Jombok, Ngoro, Jombang Regency, East Java 61473 <br> No. HP : 0852-3577-5571
                            </p>
                        </center>
                        <hr>
                        <h6 style="color: gray;">No. Antrian &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;:
                            {{ $booking->no_antrian }} <br> Nama Montir &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                            {{ $booking->montir }} <br> Tanggal Servis &nbsp;&nbsp;&nbsp;&nbsp;:
                            {{ $booking->service_date }} <br> Nama STNK
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $booking->name_stnk }}</h6>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br><br><br><br>
                                <h4 style="font-size: 14px; text-align: center; color: gray;">Admin Bengkel Totok Jaya
                                </h4>
                            </div>
                        </div>
                    </div>
