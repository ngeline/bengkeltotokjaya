    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                @if(!empty($booking))
                <a href="{{ url('laporanservice/invoice/print') }}/{{ $booking->id }}" class="btn"
                    style=" background:  #8B0000; color: white;" target="_blank"><i class="fas fa-print"></i> Print
                    PDF</a>
            </div>
            <div class="col-md-12">
                <div class="card mt-2">
                    <div class="card-body" style="color: black;">
                        <div class="col-md-12">
                            <center>
                                <p style="color: #008080;"><b style="font-size: 20px;">Bengkel Mobil Totok Jaya </b><br> Jalan Raya, Jombok, Ngoro, Jombang Regency, East Java 61473 <br> No. HP :
                                    0852-3577-5571
                                </p>
                            </center>
                            <hr>
