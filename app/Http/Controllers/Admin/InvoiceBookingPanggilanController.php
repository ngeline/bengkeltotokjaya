...
class InvoiceBookingPanggilanController extends Controller
{
    public function detail($id)
    {
        ...
        return view('admin.invoicebookingpanggilan', compact('booking', 'bookings', 'jenisServices', 'service_details', 'detailJenis'));
    }
    ...
    public function render(Request $request, $idService)
    {
        ...
        if (empty($request->all())) {
            ...
            return view('admin.addSparepartbookingpanggilan', compact('spareparts', 'category', 'id_service'));
        } else {
            $cari = $request->cari;
            $spareparts = Sparepart::where('categories.name', 'like', "%" . $cari . "%")
                ...
                ->paginate();
            $category = Category::all();
            return view('admin.addSparepartbookingpanggilan', compact('spareparts', 'category', 'cari', 'id_service'));
    ...
    public function renderService($idService)
    {
        ...
        return view('admin.addTypeServicebookingpanggilan', compact('jenisServices', 'category', 'id_service'));
    ...
    public function order(Request $request, $idSparepart, $idService)
    {
        ...
        return redirect('bookingpanggilanadmin/invoice/' . $new_service->id);
    ...
    public function invoice($id)
    {
        ...
        return view('admin.invoiceDonebookingpanggilan', compact('bookings', 'booking', 'jenisServices', 'service_details', 'detailJenis'));
    }
