...
class CategoryController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['success' => 'Merek Mobil berhasil dihapus']);
    }
    ...
    public function store(Request $request, Category $category)
    {
        ...
        return response()->json(['success' => 'Category berhasil ditambahkan']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['success' => 'Category berhasil diperbarui']);
    }
}
