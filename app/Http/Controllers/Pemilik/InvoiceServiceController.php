...
class InvoiceServiceController extends Controller
{
    public function detail($id)
    {
        ...
        if(!empty($booking))
        {
     	...
     	return view('pemilik.invoice', compact('booking', 'bookings', 'jenisServices', 'service_details', 'detailJenis'));
    }
    ...
    public function render()
    {
        ...
        return view('pemilik.addSparepart',compact('spareparts', 'category'));
    ...
    public function renderService()
    {
        $jenisServices =  JenisService::all();
        $category = Category::all();
        return view('pemilik.addTypeService',compact('jenisServices', 'category'));
    ...
    {	
    	...
    	return redirect('laporanservice/invoice/' . $new_service->id);
	...
	public function delete($id)
    {
        ...
        return redirect('laporanservice/invoice/' . $service->id);
    }
	...
	public function konfirmasi($id)
    {
        ...
        return redirect('laporanservice');
    }
    ...
    public function invoice($id)
    {
        ...
        if(!empty($booking))
        {
     	...
     	return view('pemilik.invoiceDone', compact('bookings', 'booking', 'jenisServices', 'service_details', 'detailJenis'));
    }
